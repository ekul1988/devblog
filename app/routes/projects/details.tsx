...
const ProjectDetailsPage = ({ loaderData }: Route.ComponentProps) => {
  ...
  return (
    <>
      ...
      <div className="grid gap-8 md:grid-cols-2 items-start"><div>
        <img src={project.image} alt={project.title} className='w-full rounded-lg shadow-md' /></div><div>
            <h1 className="tex-3xl font-bold text-blue-400 mb-4">{project.title}</h1>
            <p className="text-gray-300 test-sm mb-4">
